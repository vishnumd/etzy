...
public class SearchTarget {
    ...
    public final static Target INPUT_BOX_BUTTON = Target.the("the search input button").located(By.cssSelector("#gnav-search div.search-button-wrapper.hide > button"));
